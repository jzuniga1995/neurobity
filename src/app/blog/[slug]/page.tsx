...
import { Brain, Heart, BookOpen, Clock, Calendar, ArrowRight } from 'lucide-react';
...
export async function generateMetadata({ params }: PostPageProps): Promise<Metadata> {
  ...
  if (post.length === 0) {
    return {
      title: 'Post no encontrado - NeuroBity',
  ...
  return {
    title: `${postData.title} | NeuroBity Blog`,
    description: excerpt,
    keywords: `${postData.title}, psicología, neurociencia, inteligencia, IQ, desarrollo cognitivo, tests psicométricos`,
    authors: [{ name: postData.author || 'NeuroBity' }],
    openGraph: {
      title: postData.title,
      description: excerpt,
      url: `https://neurobity.com/blog/${postData.slug}`,
      siteName: 'NeuroBity',
      type: 'article',
      publishedTime: postData.published_at?.toISOString(),
      modifiedTime: postData.updated_at?.toISOString(),
      authors: [postData.author || 'NeuroBity'],
    ...
    alternates: {
      canonical: `https://neurobity.com/blog/${postData.slug}`,
    },
    robots: {
      index: true,
      follow: true,
...
export default async function BlogPostPage({ params }: PostPageProps) {
  ...
  const postData = post[0];
  const currentUrl = `https://neurobity.com/blog/${postData.slug}`;
  ...
  const articleSchema = {
    ...
    "image": postData.image_url || "https://neurobity.com/og-blog.jpg",
    ...
    "author": {
      "@type": "Person",
      "name": postData.author || "NeuroBity"
    },
    "publisher": {
      "@type": "Organization",
      "name": "NeuroBity",
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Inicio",
        "item": "https://neurobity.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Blog",
        "item": "https://neurobity.com/blog"
      },
      {
        "@type": "ListItem",
        "position": 3,
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <article className="container mx-auto px-4 py-6 sm:py-8 md:py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <header className="mb-8 md:mb-10">
              ...
              <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm text-gray-600 mb-8 pb-6 border-b border-gray-200">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg shadow-lg">
                    {(postData.author || 'N')[0].toUpperCase()}
                  </div>
                  <div>
                    <p className="font-bold text-gray-900 text-sm sm:text-base">
                      {postData.author || 'Equipo NeuroBity'}
                    </p>
                    <p className="text-xs text-gray-500">Experto en Psicología</p>
                  </div>
                </div>
              ...
              {/* Excerpt */}
              {postData.excerpt && (
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-600 p-4 sm:p-6 rounded-r-xl mb-6 sm:mb-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-12 border mb-8 sm:mb-12">
              <div 
                className="prose prose-sm sm:prose-base md:prose-lg max-w-none
                  ...
                  prose-li:text-gray-700 prose-li:my-1 sm:prose-li:my-2 prose-li:text-base sm:prose-li:text-lg
            ...
            {/* Author Bio */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-blue-200 mb-8 sm:mb-12">
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-xl sm:text-2xl shadow-lg flex-shrink-0">
                  {(postData.author || 'N')[0].toUpperCase()}
                </div>
                <div className="flex-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">
                    Escrito por {postData.author || 'Equipo NeuroBity'}
                  </h3>
                  <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
                    Expertos en psicología y neurociencia dedicados a ayudarte a comprender mejor tu mente y desarrollar todo tu potencial cognitivo.
                  </p>
            ...
            {/* CTA Section */}
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 md:p-12 text-center text-white mb-8 sm:mb-12">
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Descubre tu Potencial</h3>
              <p className="text-base sm:text-xl text-blue-100 mb-6 sm:mb-8">
                Prueba nuestros tests psicométricos gratuitos
              </p>
              ...
              <div className="mt-12 sm:mt-16">
                <div className="text-center mb-8 sm:mb-10">
                  ...
                  <p className="text-base sm:text-lg text-gray-600">
                    Continúa aprendiendo sobre psicología y neurociencia
                  </p>
                </div>
                    ...
                    >
                      <article className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col border-2 border-transparent hover:border-blue-500">
                        {relatedPost.image_url ? (
                          <div className="relative h-40 sm:h-48 overflow-hidden bg-gradient-to-br from-blue-100 to-indigo-100">
                            <Image 
                          ...
                          <div className="h-40 sm:h-48 bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                            <Brain className="w-12 h-12 sm:w-16 sm:h-16 text-white/50" strokeWidth={1.5} />
                          </div>
                        )}
